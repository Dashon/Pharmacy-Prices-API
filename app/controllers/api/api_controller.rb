class Api::ApiController < ActionController::Base
  ...
  before_filter :authenticate_request! ,:except =>  [:authenticate_user , :forgot_password, :reset_password]
  ...
  def authenticate_request!
    unless user_id_in_token?
      render json: { errors: ['Invalid Token: User id not found.'] }, status: :unauthorized
      return
    end
